...
// clears the current user brush and resets to the current real time data
  ...
  function getSGVClass(entry) {
    console.log('Getting class', entry);
  ...
  function prepareEntries ( ) {
    ...
    var temp2 = client.ddata.sgvs.map(function (obj) {
      return { mills: obj.mills, mgdl: obj.mgdl, direction: obj.direction, class: getSGVClass(obj), color: sgvToColor(obj.mgdl), type: 'sgv', noise: obj.noise, filtered: obj.filtered, unfiltered: obj.unfiltered};
    });
    client.entries = [];
